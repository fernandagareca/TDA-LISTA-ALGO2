...
void pruebas_de_crear_lista_recien_creada()
{
	...
	pa2m_afirmar(lista_tamanio(lista) == 0,
		     "lista recien creada tiene tamaño cero");
	pa2m_afirmar(lista_vacia(lista) == true,
		     "lista recien creada esta vacia");
	pa2m_afirmar(
		lista_quitar(lista) == NULL,
		"no se puede quitar el ultimo elemento de la lista sin elementos");
	pa2m_afirmar(
		lista_quitar_de_posicion(lista, 6) == NULL,
		"no es posible quitar elemento en posicion en una lista vacia");
	pa2m_afirmar(
		lista_elemento_en_posicion(lista, 6) == NULL,
		"no es posible listar elemento en posicion en una lista vacia");
	pa2m_afirmar(lista_primero(lista) == NULL,
		     "no es posible listar primer elemento en una lista vacia");
	pa2m_afirmar(lista_ultimo(lista) == NULL,
		     "no es posible listar ultimo elemento en una lista vacia");
...
void pruebas_en_una_lista_inexistente()
{
	...
	pa2m_afirmar(lista_insertar(lista, &elemento) == NULL,
		     "no se puede insertar al final  en una lista inexistente");
	pa2m_afirmar(
		lista_insertar_en_posicion(lista, &elemento, 8) == NULL,
		"no se puede insertar en la posicion de una lista inexistente");
	pa2m_afirmar(lista_tamanio(lista) == 0,
		     "lista inexistente tiene 0 elementos");
	pa2m_afirmar(lista_vacia(lista) == true,
		     "lista que no existe esta vacia");
	pa2m_afirmar(
		lista_quitar(lista) == NULL,
		"no se puede quitar el ultimo elemento de una lista inexistente");
	pa2m_afirmar(
		lista_quitar_de_posicion(lista, 6) == NULL,
		"no es posible quitar elemento en posicion en una lista inexistente");
	pa2m_afirmar(
		lista_elemento_en_posicion(lista, 6) == NULL,
		"no es posible listar elemento en posicion en una lista inexistente");
	pa2m_afirmar(
		lista_primero(lista) == NULL,
		"no es posible listar primer elemento en una lista inexistente");
	pa2m_afirmar(
...
void pruebas_de_eliminacion()
{
	...
	pa2m_afirmar(lista_quitar_de_posicion(lista, 0) == elemento1,
		     "el elemento quitado de la posicon 0 es correcto");
	pa2m_afirmar(lista_quitar_de_posicion(lista, 3) == elemento5,
		     "el elemento quitado de la posicon 3 es correcto");
	pa2m_afirmar(lista_quitar_de_posicion(lista, 6) == elemento7,
		     "el elemento quitado de la posicon 6 es correcto");
	pa2m_afirmar(lista_tamanio(lista) == 4, "la lista es tamaño 4");
	pa2m_afirmar(lista_elemento_en_posicion(lista, 0) == elemento2,
		     "el elemento del inicio es correcto");
	pa2m_afirmar(lista_elemento_en_posicion(lista, 1) == elemento3,
		     "el elemento de la posicion 1 es correcto");
	pa2m_afirmar(lista_elemento_en_posicion(lista, 2) == elemento4,
		     "el elemento de la posicion 2  es correcto");
	pa2m_afirmar(lista_elemento_en_posicion(lista, 3) == elemento6,
		     "el elemento del final es correcto");
...
{
	lista_t *lista = lista_crear();
	void *elemento1 = (void *)61, *elemento2 = NULL,
	     *elemento3 = (void *)87, *elemento4 = (void *)40,
	     *elemento5 = (void *)30, *elemento6 = (void *)10,
	     *elemento7 = (void *)80;

	pa2m_afirmar(lista_insertar(lista, elemento1) == lista,
	...
	pa2m_afirmar(lista_insertar_en_posicion(lista, elemento2, 0) == lista,
		     "insertar en la posicion 0 devuelve la lista");
	pa2m_afirmar(lista_tamanio(lista) == 2, "lista aumenta tamaño a 2");

	pa2m_afirmar(lista_insertar_en_posicion(lista, elemento3, 1) == lista,
		     "insertar en la posicion 1 devuelve la lista");
	pa2m_afirmar(lista_tamanio(lista) == 3, "lista aumenta tamaño a 3");

	pa2m_afirmar(lista_insertar_en_posicion(lista, elemento4, 100) == lista,
		     "insertar en la posicion 100 devuelve la lista");
	pa2m_afirmar(lista_tamanio(lista) == 4, "lista aumenta tamaño a 4");

	pa2m_afirmar(lista_insertar_en_posicion(lista, elemento5, 2) == lista,
		     "insertar en la posicion 2 devuelve la lista");
	pa2m_afirmar(lista_tamanio(lista) == 5, "lista aumenta tamaño a 5");

	pa2m_afirmar(lista_insertar_en_posicion(lista, elemento6, 4) == lista,
		     "insertar en la posicion 4 devuelve la lista");
	pa2m_afirmar(lista_tamanio(lista) == 6, "lista aumenta tamaño a 6");

	pa2m_afirmar(lista_insertar_en_posicion(lista, elemento7, 6) == lista,
		     "insertar en la posicion 6 devuelve la lista");
	pa2m_afirmar(lista_tamanio(lista) == 7, "lista aumenta tamaño a 7");

	pa2m_afirmar(lista_elemento_en_posicion(lista, 0) ==
			     lista_primero(lista),
		     "el primer elemento de la lista es correcto");
	pa2m_afirmar(lista_elemento_en_posicion(lista, 0) == elemento2,
		     "elemento en la posicion 0 es correcto");
	pa2m_afirmar(lista_elemento_en_posicion(lista, 1) == elemento3,
		     "elemento en la posicion 1 es correcto");
	pa2m_afirmar(lista_elemento_en_posicion(lista, 2) == elemento5,
		     "elemento en la posicion 2 es correcto");
	pa2m_afirmar(lista_elemento_en_posicion(lista, 3) == elemento1,
		     "elemento en la posicion 3 es correcto");
	pa2m_afirmar(lista_elemento_en_posicion(lista, 4) == elemento6,
		     "elemento en la posicion 4 es correcto");
	pa2m_afirmar(lista_elemento_en_posicion(lista, 5) == elemento4,
		     "elemento en la posicion 4 es correcto");
	pa2m_afirmar(lista_elemento_en_posicion(lista, 6) == elemento7,
		     "elemento en la posicion 4 es correcto");
	pa2m_afirmar(lista_elemento_en_posicion(lista, 6) ==
			     lista_ultimo(lista),
		     "el ultimo elemento de la lista es correcto");
...
void pruebas_de_busqueda_de_lista()
{
	...
	pa2m_afirmar(lista_buscar_elemento(lista, comparador, valor3) == valor3,
		     "el elemento buscado se encuentra en la lista");
	pa2m_afirmar(lista_buscar_elemento(lista, comparador, valor5) == NULL,
...
void pruebas_lista_vacia()
{
	...
	pa2m_afirmar(lista_insertar_en_posicion(lista, nombre1, 0) == lista,
		     "se inserto en la posicion 0 devuelve la lista");
	pa2m_afirmar(lista_elemento_en_posicion(lista, 0) == nombre1,
		     "elemento insertado es correcto");
	lista_destruir(lista);
}
...
void pruebas_iterdor_lista_vacia()
{
	...
	pa2m_afirmar(lista_iterador_tiene_siguiente(iterador) == false,
		     "cuando la lista esta vacia el iterador devuelve false");
	pa2m_afirmar(lista_iterador_avanzar(iterador) == false,
		     "cuanod la lista esta vacia avanzar devuelve false");
	pa2m_afirmar(lista_iterador_elemento_actual(iterador) == NULL,
		     "cuando la lista esta vacia el elemento actual es null");
	lista_destruir(lista);
	lista_iterador_destruir(iterador);
}
...
void prueba_crear_pila()
{
	...
	pa2m_afirmar(pila_apilar(pila, elemento1) == pila,
		     "se apilo un elemento devuelve la pila");
	...
	pa2m_afirmar(pila_apilar(pila, elemento2) == pila,
		     "se apilo un elemento devuelve la pila");
	pa2m_afirmar(pila_tamanio(pila) == 2, "la pila tiene tamaño 2");

	pa2m_afirmar(pila_apilar(pila, elemento3) == pila,
		     "se apilo un elemento devuelve la pila");
...
void pruebas_null_de_pila()
{
	...
	pa2m_afirmar(pila_apilar(pila, elemento) == NULL,
		     "no se puede apilar sin una pila");
	pa2m_afirmar(pila_desapilar(pila) == NULL,
		     "no se puede desapilar con una pila null");
	pa2m_afirmar(pila_tope(pila) == NULL,
		     "el tope de un pila inexistente es null");
	pa2m_afirmar(pila_tamanio(pila) == 0,
		     "el tamaño de una pila inexistente es 0");
	pa2m_afirmar(pila_vacia(pila) == true,
		     "una pila inexistente esta vacia");
}
...
void pruebas_de_cola()
{
	...
	pa2m_afirmar(cola_encolar(cola, elemento1) == cola,
		     "encolar devuelve la lista");
	...
	pa2m_afirmar(cola_desencolar(cola) == elemento1,
		     "desencolar devuelve el elemento");
	pa2m_afirmar(cola_vacia(cola) == true, "la cola vuelve a estar vacia");
	pa2m_afirmar(cola_tamanio(cola) == 0,
		     "el tamaño de la cola es 0 otra vez");

	pa2m_afirmar(cola_encolar(cola, elemento2) == cola,
		     "se encolo un nuevo elemento devuelve la cola");
	pa2m_afirmar(cola_tamanio(cola) == 1, "el tamaño de la cola es 1");
	pa2m_afirmar(cola_frente(cola) == elemento2,
		     "el primer elemento es correcto");
	pa2m_afirmar(cola_encolar(cola, elemento3) == cola,
		     "se encolo un nuevo elemento devuelve la cola");
	pa2m_afirmar(cola_tamanio(cola) == 2, "el tamaño de la cola es 2");

	pa2m_afirmar(cola_frente(cola) == elemento2,
		     "el primer elemento es correcto");
	pa2m_afirmar(cola_desencolar(cola) == elemento2,
		     "se desencolo el primer elemento es correcto");
	pa2m_afirmar(cola_frente(cola) == elemento3,
		     "el primer elemento es correcto");
...
void pruebas_null_de_cola()
{
	...
	pa2m_afirmar(cola_encolar(cola, elemento) == NULL,
		     "no se puede encolar en una cola inexistente");
	pa2m_afirmar(cola_frente(cola) == NULL,
		     "el frente de una cola inexistente es null");
	pa2m_afirmar(cola_tamanio(cola) == 0,
